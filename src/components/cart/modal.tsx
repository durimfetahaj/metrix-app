    ...
    <div>
      <button onClick={openCart}>
        <div className="flex h-11 w-11 items-center justify-center rounded-md border">
          <Icons.Cart className="h-5 w-5 transition-all ease-in-out hover:scale-110" />
        </div>
      </button>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full bg-white shadow-lg transform transition-transform ease-in-out z-50 md:w-[390px]  ${
          isOpen
      ...
      >
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <Icons.CrossIcon className="transition-all ease-in-out hover:scale-110" />
            </button>
          </div>
